...
export default function Projects() {
  ...
  const allProjects = [
    ...personalProjects.slice(0, 2),   // 1. ProjectLens AI, 2. ALLYVEX
    ...freelanceProjects,              // 3. Career Recruit AI, 4. Silent Emergency
    ...personalProjects.slice(2),      // rest of personal projects
  ];
